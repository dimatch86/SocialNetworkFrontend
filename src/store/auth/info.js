    ...
    pages: {
      ...
      ru: {
        login: {
          title: 'Привет!',
          text:
            'Мы создали это место, чтобы вы смогли развиваться, чувствуя себя максимально комфортно в кругу приятных людей. Это сообщество профессионалов, объединённых одной идеей — с помощью кода, магия станет реальностью!',
          btn: {
            link: 'Registration',
            text: 'Регистрация'
          }
        ...
        forgot: {
          ...
          text:
            'Чтобы восстановить пароль, укажите e-mail, к которому привязана ваша страница. Мы отправим код для восстановления пароля туда.',
          btn: {
            link: 'Login',
            text: 'Перейти к восстановлению',
            variant: 'dark'
          }
        },
        'forgot-success-confirmation': {
