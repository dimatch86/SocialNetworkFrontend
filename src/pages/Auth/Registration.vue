    ...
    form.registration__form(@submit.prevent='submitHandler')
        .form__block
            ...
            password-field#register-password(
                ...
                info,
                registration,
                :class='{ checked: $v.passwd1.required && $v.passwd1.checkPass }',
                autocomplete='new-password'
            )
            password-repeat-field#register-repeat-password(
                v-model='passwd2',
                :v='$v.passwd2',
                :class='{ checked: $v.passwd2.required && $v.passwd2.sameAsPassword && $v.passwd1.checkPass}',
                autocomplete='new-password'
            )
        .form__block
...
export default {
    ...
    validations: {
        ...
        passwd1: { required, checkPass: helpers.regex('passwd1', /^(?=.*[a-z])(?=.*[A-Z])(?=.*[!@#$&*])(?=.*[0-9]).{8,}$/) },
